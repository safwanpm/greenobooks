               ...
               <div class="midde_cont">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('textbook.update',$textbook->id) }}" method="POST">
                       @csrf
                       @method('PUT')
                        <div class="row">
                        <div class="col-sm">
                        <label for="exampleInputName1">School</label>
                        <input type="text" class="form-control"name="school" placeholder="Select school"><br>
                      </div>
                      <div class="col-sm">
                      <label for="exampleInputName1">Class</label>
                        <input type="text" class="form-control"name="class"placeholder="select class"><br>
                      </div>
                     </div>
                     <div class="row">
                     <div class="col-sm">
                        <label for="exampleInputEmail3">Subject</label>
                        <input type="text" class="form-control" name="subject" value="{{$textbook->subject}}"><br>
                      </div>
                      <!-- <div class="col-sm">
                      ...
                      <div class="col-sm">
                        ...
                        <input type="text" class="form-control"name="bookname" value="{{$textbook->bookname}}"><br>
                      </div>
                      <div class="col-sm">
                        <label for="exampleInputPassword4">Publisher</label><br>
                        <input type="text" class="form-control" name="publisher" value="{{$textbook->publisher}}"><br>
                      </div>
                      </div>
                      <div class="row">
                      <div class="col-sm">
                        <label for="exampleInputPassword4">HSN</label>
                        <input type="text" class="form-control" name="hsn" value="{{$textbook->hsn}}"><br>
                      </div>
                      <div class="col-sm">
                        <label for="exampleInputPassword4">GST</label>
                        <input type="text" class="form-control" name="gst" value="{{$textbook->gst}}"><br>
                      </div>
                      <!-- <div class="col-sm">
                      ...
                      <div class="col-sm">
                        ...
                        <input type="text" class="form-control" name="price" value="{{$textbook->price}}" ><br>
                      </div>
                      <div class="col-sm">
