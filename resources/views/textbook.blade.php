            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="widgets.html"><i class="fa fa-book purple_color"></i> <span>Textbook</span></a></li>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Select school"><br>
                      </div>
                      <div class="col-sm">
                      <label for="exampleInputName1">Class</label>
                        <input type="email" class="form-control" id="exampleInputName1"placeholder="select class"><br>
                      </div>
                     </div>
                     <div>
                     <div class="col-md-12">
                                    ...
                                    <table class="table table-hover">
                                       ...
                                       @foreach ($txt as $text)
                                          <tr>
                                             ...
                                             <td>{{ $text->gst }}</td>
                                             <td>{{ $text->price }}</td>
                                            <td><a href="{{ route('textbook.edit',$text->id) }}">edit</a>
                                          </tr>
                                          @endforeach
                                       </tbody>
                                    </table>
