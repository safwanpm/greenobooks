         ...
         <div class="inner_container">
            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="widgets.html"><i class="fa fa-university purple_color"></i> <span>Dashboard</span></a></li>
                     <li><a href="widgets.html"><i class="fa fa-university green_color"></i> <span>School</span></a></li>
                     <li><a href="widgets.html"><i class="fa fa-user red_color"></i> <span>Student</span></a></li>
                     ...
                     <li><a href="tables.html"><i class="fa fa-truck purple_color2"></i> <span>Shipping Charge</span></a></li>
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                ...
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">ADD SCHOOL WISE NOTEBOOK</h3>
                    <form class="forms-sample">
                        <div class="row">
                        <div class="col-sm">
                        <label for="exampleInputName1">School Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="School Name">
                      </div>
                      <div class="col-sm">
                     ...
                     <div class="row">
                     <div class="col-sm">
                        <label for="exampleInputEmail3">Catagary</label>
                      ...
                      <div class="col-sm">
                        <label for="exampleInputPassword4">Page</label>
                        <input type="text" class="form-control" id="exampleInputPassword4"><br>
                      </div>
                      </div>
                      <div class="row">
                      ...
                      <!-- <div class="col-sm">
                        <label for="exampleInputPassword4">School Type</label>
                        <input type="boolean" class="form-control" id="exampleInputPassword4" placeholder="Select School Type"><br>
                      </div> -->
                      </div>
