               ...
               <div class="midde_cont">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('notebook.store')}}" method="POST">
                       @csrf
                        <div class="row">
                        <div class="col-sm">
                        <label for="exampleInputName1">Category</label>
                        <input type="text" class="form-control"name="category" placeholder="Select catagory"><br>
                      </div>
                      <div class="col-sm">
                      <label for="exampleInputName1">Brand</label>
                        <input type="text" class="form-control"name="brand"placeholder="select Brand"><br>
                      </div>
                     </div>
                      ...
                      <div class="row">
                      <div class="col-sm">
                        <label for="exampleInputPassword4">Speciality</label><br>
                        <input type="text" class="form-control"name="speciality"><br>
                      </div>
                      <div class="col-sm">
                        <label for="exampleInputPassword4">Pages</label><br>
                        <input type="text" class="form-control" name="pages"><br>
                      </div>
                      </div>
                      <div class="row">
                      <div class="col-sm">
